...
{
public:
	Effect(Vector2 position, D3DXCOLOR color, ChangeMode change_mode, float size, float destroy_time);
	~Effect();
...
public:
	...
	void AddParticleEffect(Vector2 position, D3DXCOLOR color, ChangeMode changeMode, float size = 1, float destroyTime = 1);
